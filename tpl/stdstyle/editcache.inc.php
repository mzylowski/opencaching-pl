...
$pictureline = '<tr class="form-group-sm"><td colspan="2">{seq_drop}<img src="tpl/stdstyle/images/free_icons/picture.png" class="icon32" alt="" />&nbsp;<a href="{link}" rel="noopener" target="_blank">{title}</a>&nbsp;&nbsp;<img src="images/actions/edit-16.png" align="middle" alt="" title="" /> [<a href="editpic.php?uuid={uuid}" onclick="return check_if_proceed();"  >' . $edit . '</a>] <img src="tpl/stdstyle/images/log/16x16-trash.png" border="0" align="middle" class="icon16" alt="" title="" />[<a href="removepic.php?uuid={uuid}" onclick="if (confirm(\'' . tr('ec_delete_pic') . '\')) {return check_if_proceed();} else {return false;};">' . $remove . '</a>]</td></tr>';
$picturelines = '{lines}<tr><td colspan="2">&nbsp;</td></tr>';

$nomp3 = '<tr><td colspan="2"><div class="notice">' . tr('no_mp3_files') . '</div></td></tr>';
$mp3line = '<tr><td colspan="2">{seq_drop_mp3}<img src="tpl/stdstyle/images/free_icons/sound.png" class="icon32" alt=""  />&nbsp;<a rel="noopener" target="_blank" href="{link}">{title}</a>&nbsp;&nbsp;<img src="images/actions/edit-16.png"  align="middle"  alt="" title="" /> [<a href="editmp3.php?uuid={uuid}" onclick="return check_if_proceed();">' . $edit . '</a>] <img src="tpl/stdstyle/images/log/16x16-trash.png" border="0" align="middle" class="icon16" alt="" title="" />[<a href="removemp3.php?uuid={uuid}" onclick="if (confirm(\'' . tr('ec_delete_mp3') . '\')) {return check_if_proceed();} else {return false;};">' . $remove . '</a>]</td></tr>';
